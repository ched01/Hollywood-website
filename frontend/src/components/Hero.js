...
export default function Hero({ onNavigate }) {
    ...
    return (
        <section id="the-night" data-testid="hero-section" className="relative min-h-screen overflow-hidden bg-night">
            ...
            <motion.div
                ...
                aria-hidden="true"
            >
                <span className="font-display font-semibold text-outline-faint text-[22vw] leading-none tracking-tight whitespace-nowrap">
                    OSCARS
                </span>
            </motion.div>
                ...
                <div className="max-w-5xl">
                    <MaskedLine delay={0.15}>
                        <span className="text-xs sm:text-sm tracking-[0.45em] uppercase text-gold font-body">
                            The 98th Academy Awards · 03.15.2026
                        </span>
                    </MaskedLine>
                    <h1 className="mt-6 font-display font-medium leading-[0.92] tracking-tighter text-6xl sm:text-8xl lg:text-[9.5rem]">
                        <MaskedLine delay={0.3}>One night.</MaskedLine>
                        <MaskedLine delay={0.45}>
                            All of <em className="text-gold gold-glow not-italic font-semibold">Hollywood.</em>
                        </MaskedLine>
                    </h1>
                    <MaskedLine delay={0.65} className="mt-8 max-w-xl">
                        <span className="text-base sm:text-lg font-light text-white/70 leading-relaxed">
                            The statuette waits beneath the lights of the Dolby Theatre.
                            Twenty-four categories. One envelope at a time.
                        </span>
                    </MaskedLine>
                    <motion.div
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="relative">Reserve your seat</span>
                        </button>
                        <button
                            data-testid="hero-contenders-button"
                            onClick={() => onNavigate("#contenders")}
            ...
            >
                <span className="text-[10px] tracking-[0.35em] uppercase rotate-90 origin-center translate-y-[-8px]">Scroll</span>
